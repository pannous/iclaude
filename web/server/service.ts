...
export function generateSystemdUnit(opts: UnitOptions): string {
  ...
  return `[Unit]
Description=iClaude - Web UI for Claude Code
...
async function installDarwin(opts?: { port?: number }): Promise<void> {
  ...
  if (existsSync(PLIST_PATH)) {
    console.error("iClaude is already installed as a service.");
  ...
  console.log("iClaude has been installed as a background service.");
  console.log("");
...
async function uninstallDarwin(): Promise<void> {
  ...
  console.log("iClaude service has been removed.");
...
async function startDarwin(): Promise<void> {
  ...
  console.log("iClaude service has been started.");
}
...
async function stopDarwin(): Promise<void> {
  ...
  console.log("iClaude service has been stopped.");
...
async function restartDarwin(): Promise<void> {
  ...
  console.log("iClaude service has been restarted.");
}
