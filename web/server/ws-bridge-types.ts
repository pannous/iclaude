...
export interface ViteHmrSocketData {
  kind: "vite-hmr";
...
export interface Session {
  ...
  /** Pending control_request messages awaiting control_response from CLI. */
  ...
  title?: string; // LOCAL: session title
  /** Timestamp when session was created */
  createdAt?: number; // LOCAL: session creation time
  nextEventSeq: number;
...
export function makeDefaultState(
  ...
  return {
    ...
    cwd: "",
    tools: [],
    // LOCAL: default to bypassPermissions (agent mode) — upstream uses "default"
