  ...
  return (
    <aside className="w-[260px] h-full flex flex-col bg-cc-sidebar border-r border-cc-border">
      ...
      <div className="p-3 pb-2">
        <a href="https://github.com/pannous/companion" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 mb-3 hover:opacity-80 transition-opacity">
