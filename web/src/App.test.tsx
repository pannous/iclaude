...
vi.mock("./api.js", () => ({
  autoAuth: vi.fn().mockResolvedValue(null),
  api: {
...
describe("App", () => {
  ...
  describe("authenticated layout", () => {
    ...
    it("renders ProcessPanel when activeTab is processes", async () => {
      // Processes page should render the lazy-loaded ProcessPanel.
      (parseHash as ReturnType<typeof vi.fn>).mockReturnValue({ page: "processes" });
      setStoreValues({ currentSessionId: "s1" });
      render(<App />);
