...
|---|---|
| Solo developer, single machine | [Local install](/get-started/installation) with `bunx iclaude` |
...
|---|---|
| `iclaude status` | Check if the service is running |
| `iclaude logs` | Tail recent logs |
| `iclaude restart` | Restart the server |
| `iclaude stop` | Stop the server |
...
- Review server logs: `iclaude logs`
