...
The default image (`iclaude:latest`) is based on Ubuntu 24.04 and includes:
...
3. Select a **base image** from the dropdown (e.g., `iclaude:latest`) or enter a custom image name
