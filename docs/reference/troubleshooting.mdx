...
```bash
COMPANION_AUTH_TOKEN="my-token" iclaude
```
...
Check server logs: `iclaude logs`
...
- Try pulling manually: `docker pull iclaude:latest`
...
- View server logs for relaunch errors: `iclaude logs`
