...
## [0.24.0](https://github.com/pannous/companion/compare/the-vibe-companion-v0.23.0...the-vibe-companion-v0.24.0) (2026-02-12)


### Features

* add global YOLO mode toggle in Composer ([9e04a1a](https://github.com/pannous/companion/commit/9e04a1a944596b3f03a0ec6782578dd8e0b1d022))
...
* add system command execution API for HTML fragments in YOLO mode ([1a87f2f](https://github.com/pannous/companion/commit/1a87f2fc29e930c432a2828a6826ad0508e3f399))
...
* **cli:** add service install/uninstall and separate dev/prod ports ([#155](https://github.com/pannous/companion/issues/155)) ([a4e5ba6](https://github.com/pannous/companion/commit/a4e5ba6ced2cc8041f61b303b0205f36e50b7594))
* Corriger menu dossier mobile et décalage clavier ([#151](https://github.com/pannous/companion/issues/151)) ([8068925](https://github.com/pannous/companion/commit/8068925f6a5ec5c6b7a40b36398bd4f9be04708d))
...
* Hide successful no-output command results ([#139](https://github.com/pannous/companion/issues/139)) ([a66e386](https://github.com/pannous/companion/commit/a66e386491e6887c5684cd70f63cc49cac0a64b7))
* **landing:** add marketing landing page for thecompanion.sh ([#128](https://github.com/pannous/companion/issues/128)) ([170b89c](https://github.com/pannous/companion/commit/170b89c72012dfb0ba68239a7665634d65275aa3))
* **major:** add /sessions/:id/message endpoint for Listen integration ([33901e6](https://github.com/pannous/companion/commit/33901e6c9a099ff8a25f5a81583d7a0f7e8eba79))
* **major:** add OpenAI-compatible endpoints for external integrations ([950002d](https://github.com/pannous/companion/commit/950002da4352e259143176dfb91ee721c322d938))
* **major:** HTML Skills plugin system — full frontend integration ([1dc8edf](https://github.com/pannous/companion/commit/1dc8edf953f63567b9738120ca7d7984a7d54d8f))
* **major:** implement WebSocket handling for chat completions endpoint ([301f9fc](https://github.com/pannous/companion/commit/301f9fcbe588188b1e122e622188d221b9ab9475))
* **major:** pre-warm Claude CLI for instant session start ([05aa77e](https://github.com/pannous/companion/commit/05aa77ed7b259fed181a772f32468ea373ba771c))
* **minor:** add "Inactive Only" option to archive sessions dialog ([204e162](https://github.com/pannous/companion/commit/204e162a7c299eeb9e15edde334ee3eaf60336c0))
* **minor:** add Alt+Ctrl+PageUp/PageDown shortcuts for session navigation ([dab8770](https://github.com/pannous/companion/commit/dab8770c8d694e412fcac39175d2390d6ea96d87))
...
* **minor:** add Alt+X keyboard shortcut to archive current session ([3634d2d](https://github.com/pannous/companion/commit/3634d2d54ecffbdc502955a0921b982444f3108d))
...
* **minor:** add browser back/forward button support for session navigation ([32e66bd](https://github.com/pannous/companion/commit/32e66bd4eec39077554c6c0c36dc51c32d53e680))
...
* **minor:** add Clear button next to archived sessions list ([19027a9](https://github.com/pannous/companion/commit/19027a9d721232837d7ec25be04e71c8a28cc897))
...
* **minor:** add Ctrl+S and Ctrl+T keyboard shortcuts to start new session ([915a0ee](https://github.com/pannous/companion/commit/915a0ee7f0ac14bd16350352d8e85021951e6138))
...
* **minor:** add error monitor that spawns Claude agent to auto-fix dev errors ([2eb31c6](https://github.com/pannous/companion/commit/2eb31c62aa7caa87c04c16485bf5b01220f6b48f))
...
* **minor:** add HTML Skills API routes ([2c44f61](https://github.com/pannous/companion/commit/2c44f619b31ec406b352e2963ca40d9142d18e7b))
* **minor:** add HTML Skills backend — skill-manager module ([a987072](https://github.com/pannous/companion/commit/a98707263a4b05d4664ea8d598e86874c61b4fe7))
* **minor:** add keyboard shortcuts to navigate between sessions ([1248c58](https://github.com/pannous/companion/commit/1248c58ba22a2bcef2df245938f540b74e820a29))
...
* **minor:** add middle mouse button to archive current session ([2956516](https://github.com/pannous/companion/commit/2956516550221e084bd2c3f80b8945275f5e5838))
...
* **minor:** add OpenAI-compatible chat completions endpoint ([e88b3e9](https://github.com/pannous/companion/commit/e88b3e9a850f4202121c92e56fcda853c6fb8134))
...
* **minor:** allow sessions in any directory (not just home) ([d9c61bf](https://github.com/pannous/companion/commit/d9c61bf1adf87c7c233c148444f043d5014414fe))
...
* **minor:** auto-detect and render HTML fragments inline ([276d883](https://github.com/pannous/companion/commit/276d88351b012a0c02e97e01b1cde03103c1815c))
* **minor:** change dev server port from 5174 to 2345 ([8778c95](https://github.com/pannous/companion/commit/8778c95c2558aff63962deb642e97ebe865b20d4))
...
* **minor:** hide raw HTML source in chat, add Source toggle to HtmlPreview ([2a6fc42](https://github.com/pannous/companion/commit/2a6fc42eb334be5ac4ee442c04b843698b4fe4db))
...
* **minor:** move model label next to branch in sidebar session items ([32502cf](https://github.com/pannous/companion/commit/32502cf08d8b38c6d70f56f37fe7ea456bb615e4))
* **minor:** new session inherits cwd from current session ([ea6570c](https://github.com/pannous/companion/commit/ea6570c5e789fc906d2b749d3d7be8583d8f365d))
* **minor:** populate folder picker with session working directories ([ddaffa7](https://github.com/pannous/companion/commit/ddaffa78212f1aa7292d67ef0740f61846fc9dd3))
...
* **minor:** show result first paragraph in session-done notifications ([ec65a6e](https://github.com/pannous/companion/commit/ec65a6e0d8f1955e8366abb88b28236d37c462d5))
* **minor:** show session name in top bar instead of "Connected" text ([c33f697](https://github.com/pannous/companion/commit/c33f69791c96dd450eab8bf210fbc05066413d6e))
...
* **minor:** typecheck-gated backend restarts in dev server ([1b03386](https://github.com/pannous/companion/commit/1b033867707f72ebd8e2c184cae87a69210d8900))
* **minor:** typecheck-gated backend restarts in dev server ([2d527ea](https://github.com/pannous/companion/commit/2d527ea7be128c68374b629cb6ed9ccd878e0ecf))
* **minor:** use browser Notification API for vibe.notify ([8117696](https://github.com/pannous/companion/commit/811769680bd25094bf28dcefeeaeb83c08c9b891))
...
* **ui:** expand HTML fragments by default ([048b533](https://github.com/pannous/companion/commit/048b5334a8a845759c7c37e6f5cdf701c8d8eb56))
* **ui:** make Vibe Companion title a link to GitHub repo and remove 'The' ([f69cfbd](https://github.com/pannous/companion/commit/f69cfbd905ddb925718b063248ee60fa5c908811))
* **ui:** make Vibe Companion title a link to GitHub repo and remove 'The' ([6821eb0](https://github.com/pannous/companion/commit/6821eb0ec78cd70e6d489cb5e69db2030eeaf1e8))
...
* **web:** add missing message-flow components to Playground ([#156](https://github.com/pannous/companion/issues/156)) ([ef6c27d](https://github.com/pannous/companion/commit/ef6c27dfa950c11b09394c74c4452c0b02aed8fb))
...
* **web:** add per-session usage limits with OAuth refresh and Codex support ([24ebd32](https://github.com/pannous/companion/commit/24ebd32f5ec617290b6b93e8bc76972a3b80d6a9))
...
* **web:** add PWA support for mobile home screen install ([#116](https://github.com/pannous/companion/issues/116)) ([85e605f](https://github.com/pannous/companion/commit/85e605fd758ee952e0d5b1dbc6f7065b514844a7))
* **web:** add update-available banner with auto-update for service mode ([#158](https://github.com/pannous/companion/issues/158)) ([727bd7f](https://github.com/pannous/companion/commit/727bd7fbd16557fd63ce41632592c1485e69713c))
...
* **web:** group sidebar sessions by project directory ([#117](https://github.com/pannous/companion/issues/117)) ([deceb59](https://github.com/pannous/companion/commit/deceb599975f53141e9c0bd6c7675437f96978b8))
...
* **web:** redesign session list with avatars, auto-reconnect, and git info ([#111](https://github.com/pannous/companion/issues/111)) ([8a7284b](https://github.com/pannous/companion/commit/8a7284b3c08dc301a879924aea133945697b037a))
* **web:** replace CodeMirror editor with unified diff viewer ([#160](https://github.com/pannous/companion/issues/160)) ([f9b6869](https://github.com/pannous/companion/commit/f9b686902011ffd194a118cc1cb022bac71eaa3b))
...
* **web:** warn when branch is behind remote before session creation ([#127](https://github.com/pannous/companion/issues/127)) ([ef89d5c](https://github.com/pannous/companion/commit/ef89d5c208ca5da006aaa88b78dbd647186fb0df))
* **yolo:** add YOLO mode toggle for unrestricted HTML rendering ([3b03d84](https://github.com/pannous/companion/commit/3b03d843bea4f7e4a2a5503dbf3c246eb4472e29))


### Bug Fixes

* add Ctrl+Delete as alternative archive shortcut for Firefox compatibility ([1b2b286](https://github.com/pannous/companion/commit/1b2b286d05ec54178c70da53d372250e58d6a5b2))
...
* add missing store properties and skip integration tests without server ([7c3a8ea](https://github.com/pannous/companion/commit/7c3a8ea1cfb635ceebda3ade02fdc645435bea01))
...
* align tests with DiffViewer component after CodeMirror removal ([#160](https://github.com/pannous/companion/issues/160)) ([6941895](https://github.com/pannous/companion/commit/69418954bfc99af231a974e4491a73b94f8ab45e))
...
* archive button for bridge-only sessions showing model name as title ([42ec13d](https://github.com/pannous/companion/commit/42ec13d8b8b4b919c24849c8723d8587f6ad587a))
* archive button not working for sessions needing reconnection ([803e3df](https://github.com/pannous/companion/commit/803e3df7616880d091838f86e4d53f0b1b41c059))
...
* auto-approve permissions in dontAsk mode ([a9daf0c](https://github.com/pannous/companion/commit/a9daf0ce8bf88e262cae52e4e874eef0a239c2c0))
...
* **codex:** fix 3 critical bugs in Codex backend integration ([#147](https://github.com/pannous/companion/issues/147)) ([0ec92db](https://github.com/pannous/companion/commit/0ec92db909c7be42f94cc21d2890c9c123702dd7))
* correct port numbers in CLAUDE.md (5174 -&gt; 2345 for Vite dev server) ([7812118](https://github.com/pannous/companion/commit/78121183cfb2ff76b68147ea470d3670e41f4e64))
...
* correct port numbers in documentation and scripts ([7fb5b74](https://github.com/pannous/companion/commit/7fb5b74e0461d12cf31403966c461a12a2bec290))
...
* deduplicate assistant messages server-side to prevent history bloat ([6a11cb6](https://github.com/pannous/companion/commit/6a11cb64ec9a4bcc7c856b828a8c0678807964fb))
* defer AudioContext creation until after user gesture ([31e948e](https://github.com/pannous/companion/commit/31e948e89205161a7e395df70450fd9af92183c1))
* defer AudioContext creation until after user gesture ([fa63c01](https://github.com/pannous/companion/commit/fa63c01dbc5bd8a101424e9debfae6bd9de9e983))
...
* filter auto-namer sessions from resume picker ([30a5d64](https://github.com/pannous/companion/commit/30a5d64984dd7c12fad5266155a9b0b70bddf6c4))
...
* merge streaming chunks when loading CLI message history ([1e19f20](https://github.com/pannous/companion/commit/1e19f20afd3788441ee7f67da9cfae7c33ab71ef))
* **merge:** resolve TypeScript errors after merge ([9f9b48d](https://github.com/pannous/companion/commit/9f9b48dd1f647e3ba091f1e8ac5d3465a42e5847))
* **minor:** improve HTML fragment detection and preview ([a153788](https://github.com/pannous/companion/commit/a15378858f6983ac8fcae880e30e5802996d6d82))
* **minor:** use SDK title in session completion notifications ([7e742e3](https://github.com/pannous/companion/commit/7e742e3e26d2c632ba77f9298570e7d44eb56509))
...
* prevent ghost session files from being created ([b6d9fd8](https://github.com/pannous/companion/commit/b6d9fd8a35eaf70287be4ea081cb21092b803c46))
* prune ghost sessions from launcher.json on restore ([238f627](https://github.com/pannous/companion/commit/238f627592809d2f9062bcc507fc744e8b2eb9d9))
* purge ghost sessions that reappear after deletion ([8d5abff](https://github.com/pannous/companion/commit/8d5abff99ab01b8d0f209d9da02f125cf25c4c9f))
* reload CLI message history on reconnect after server restart ([61adf4b](https://github.com/pannous/companion/commit/61adf4b99dcad42ee2d49c03cd6976e214f3ece0))
* remove hash routing to prevent session restoration interference ([79d1b5f](https://github.com/pannous/companion/commit/79d1b5f6439eff674a98c308f90c1511e722c606))
* remove home directory restriction from cwd and filesystem paths ([3f4fa69](https://github.com/pannous/companion/commit/3f4fa69f6d1ba02837cca5dc40027f571f6246df))
* remove orphaned EditorPanel.tsx and title-generator.ts breaking CI ([b7203ec](https://github.com/pannous/companion/commit/b7203ecfe86c8d49925ba8c8d9fff456dd68cccd))
...
* resolve Bun segfault by upgrading to 1.3.9 ([edfc5bc](https://github.com/pannous/companion/commit/edfc5bcde117cc692db023cb3ef1c5f22620245e))
...
* restore corrupted files from backup-before-remerge branch ([3d09996](https://github.com/pannous/companion/commit/3d099960b740656a9da28eb8787fa94fe314b45c))
* restore missing EditorPanel.tsx component (494 lines) ([99ad5de](https://github.com/pannous/companion/commit/99ad5de373d4c5431b6ee399830dc7d07b211f16))
* restore Resume Session button in sidebar ([5bfee25](https://github.com/pannous/companion/commit/5bfee25c0014146038be02c34af79ebad1afb20c))
...
* **security:** remove allow-same-origin from HTML iframe sandbox ([af4c6fd](https://github.com/pannous/companion/commit/af4c6fdd5014712c76ca2fc208bf90cf7e6c39d9))
* show Claude-generated session title in top bar instead of random name ([ac18178](https://github.com/pannous/companion/commit/ac181788f6afb05718d8e46db0e5b9390f701f7f))
...
* show title for ghost sessions using first user message fallback ([bd0e8d8](https://github.com/pannous/companion/commit/bd0e8d8cd2f55be92f9519492577285c28d7b47b))
...
* **ui:** remove max-width constraint on TopBar title to use full available space ([ed7e361](https://github.com/pannous/companion/commit/ed7e361fd80eefddb88430abc85debf404f2e56f))
...
* use SDK session state for inactive detection and add Delete Archived ([3423a26](https://github.com/pannous/companion/commit/3423a269ed126546778e1cd6ac04a38f40f2eb16))
* use session title as notification title instead of "Session done: ..." ([45c496e](https://github.com/pannous/companion/commit/45c496ebf8771a29c9703edbacc8da00be291245))
* **web:** always generate unique branch names for worktrees with forceNew ([#131](https://github.com/pannous/companion/issues/131)) ([cd62d4a](https://github.com/pannous/companion/commit/cd62d4ac8fae0b56cdef0ff850eab4a8c707f99b))
...
* **web:** deduplicate messages on WebSocket reconnection ([#150](https://github.com/pannous/companion/issues/150)) ([a81bb3d](https://github.com/pannous/companion/commit/a81bb3d878957f1f18234a5f9194d1d8064f795c))
* **web:** default folder picker to home directory instead of server cwd ([#122](https://github.com/pannous/companion/issues/122)) ([7b8a4c7](https://github.com/pannous/companion/commit/7b8a4c71f32c68ffcc907269e88b3711c0d5af7a))
* **web:** enable codex web search when internet toggle is on ([#135](https://github.com/pannous/companion/issues/135)) ([8d9f0b0](https://github.com/pannous/companion/commit/8d9f0b002dcafcfc020862cb107777d75fc2580e))
* **web:** fetch and pull selected branch on session create ([#137](https://github.com/pannous/companion/issues/137)) ([9cdbbe1](https://github.com/pannous/companion/commit/9cdbbe1e151f024bd41f60e20c60e2f092ba7014))
* **web:** fix Codex approval policy and Composer mode labels ([#106](https://github.com/pannous/companion/issues/106)) ([fd5c2f1](https://github.com/pannous/companion/commit/fd5c2f15b144eb2ae9ec809fdb6ee19e797dc15a))
...
* **web:** fix WritableStream locked race condition in Codex adapter ([b43569d](https://github.com/pannous/companion/commit/b43569dbb3d154a303d60ec6bc2007b5a7bcedea))
...
* **web:** polyfill localStorage for Node.js 22+ ([#149](https://github.com/pannous/companion/issues/149)) ([602c684](https://github.com/pannous/companion/commit/602c6841f03677ec3f419860469e39b791968de6))
* **web:** prevent iOS auto-zoom on mobile input focus ([#102](https://github.com/pannous/companion/issues/102)) ([18ee23f](https://github.com/pannous/companion/commit/18ee23f6f1674fbcf5e1be25f8c4e23510bc12b5))
* **web:** prevent mobile keyboard layout shift and iOS zoom on branch selector ([#159](https://github.com/pannous/companion/issues/159)) ([4276afd](https://github.com/pannous/companion/commit/4276afd4390808d9d040555652c80bd1461c45b7))
* **web:** rename misleading "dangerous" mode label to "ask" ([2bb8805](https://github.com/pannous/companion/commit/2bb880503f66dd4f800d5d51f92b115a8f7dd34b))
* **web:** replace dontAsk with default in permission mode cycle ([42ff5e7](https://github.com/pannous/companion/commit/42ff5e79db3a0c4a9f84f3d8697131bfc30a7e89))
* **web:** resolve [object Object] display for Codex file edit results ([#133](https://github.com/pannous/companion/issues/133)) ([9cc21a7](https://github.com/pannous/companion/commit/9cc21a78064cf07bb90174dd87bbfbd367516c90))
* **web:** resolve original repo root for worktree sessions in sidebar grouping ([#120](https://github.com/pannous/companion/issues/120)) ([8925ac9](https://github.com/pannous/companion/commit/8925ac9f540b3cd2520268539d21b0267b2dadb1))
...
* **web:** use SDK title in sidebar session items like TopBar does ([7529bc4](https://github.com/pannous/companion/commit/7529bc49b6b426f0709809b606a4ea373c279755))
* **web:** use SDK title in sidebar session items like TopBar does ([b35baa8](https://github.com/pannous/companion/commit/b35baa80463d3a8b527986c7413b197493dc5004))
